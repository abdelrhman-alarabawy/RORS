...
if(login.validate_username())
{
    if(login.validate_password())
    {
        username_error_label.setText("");
        password_error_label.setText("");
        usertype=login.get_owner_type();
...
//JOptionPane.showMessageDialog(null,"Manager login !","SUCC!",JOptionPane.PLAIN_MESSAGE);    
        ...
        {
            ChiefScreen screen2=new ChiefScreen();
...
//JOptionPane.showMessageDialog(null,"chief login !","SUCC!",JOptionPane.PLAIN_MESSAGE);
        ...
        {
            WaiterScreen screen3=new WaiterScreen();
...
//JOptionPane.showMessageDialog(null,"waiter login !","SUCC!",JOptionPane.PLAIN_MESSAGE);
    ...
    username_error_label.setText("INCORRECT USERNAME...!");
